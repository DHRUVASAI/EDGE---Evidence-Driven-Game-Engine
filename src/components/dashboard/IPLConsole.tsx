...
const TEAMS: Record<string, TeamDetail> = {
  ...
  RCB: { logo: "RCB", name: "Royal Challengers Bengaluru", gradient: "from-red-700 to-zinc-800 text-white", borderActive: "border-red-500", textActive: "text-red-500", borderInactive: "border-red-700/20 hover:border-red-700/40", textInactive: "text-red-700/50 hover:text-red-500", glow: "rgba(220,38,38,0.25)", colorName: "#dc2626", titles: 0 },
